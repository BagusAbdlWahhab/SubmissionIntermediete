...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val homeSweetHome = LatLng(-6.1690, 106.6800)
        mMap.addMarker(
            MarkerOptions()
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(homeSweetHome, 15f))
    }

    private fun addMarkerForStory(story: StoryItem) {
